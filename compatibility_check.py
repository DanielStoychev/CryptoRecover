...
if sys.version_info < (3, 6):
	...
	sys.stdout.write("Sorry, CryptoRecover no longer supports Python2 as it is officially End-of-Life...\n\n")
	...
	sys.stdout.write("Python2 releases and documentation for installing and using this tool with Python3 can be found at from https://github.com/DanielStoychev/CryptoRecover.\n\n")
